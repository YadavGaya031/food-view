    ...
    <div className="min-h-screen bg-gray-50 text-slate-900 dark:bg-[#0b0c0f] dark:text-slate-100 flex items-center justify-center px-4 py-10">
      ...
      >
        <header className="mb-6">
          <h1 id="user-login-title" className="text-2xl font-semibold tracking-tight">Welcome back</h1>
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-300/90">Sign in to continue your food journey.</p>
        </header>
